    ...
    <div className="flex-col">
      ...
      <div className="flex-col">
        ...
        >
          ...
          <option value="High">
            Moderate : I accept a fair amount of fluctuation in my initial
            investment amount in order to achieve above average returns and
            capital growth.
          </option>
          <option value="Low">
            Low : I accept steady and minimal returns without any fluctuations
            in my initial investment amount.
          </option>
        </select>
      </div>
    </div>
